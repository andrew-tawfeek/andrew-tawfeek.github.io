...
(function () {
  ...
  const ICONS = {
    ...
    play: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4zm6 3.5v7l5.5-3.5L10 7.5zM3 21a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1z"/></svg>',
  ...
  function getLinkIcon(type) {
    ...
    if (type === 'presentation') return ICONS.play;
